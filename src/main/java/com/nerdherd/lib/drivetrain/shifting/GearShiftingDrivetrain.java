 ...
 * Add your docs here.
 */
public class GearShiftingDrivetrain extends AbstractGearShiftingDrivetrain {
  ...
  private Piston m_leftShifter, m_rightShifter;
  public Command defaultCommand;

  public GearShiftingDrivetrain(int leftTalonMasterID, int rightTalonMasterID, NerdyTalon[] leftSlaves, 
                                NerdyTalon[] rightSlaves, boolean leftInversion, boolean rightInversion,
                                Piston leftShifter, Piston rightShifter) {
    ...
    m_leftShifter = leftShifter;
    m_rightShifter = rightShifter;
  }

  public GearShiftingDrivetrain(int leftTalonMasterID, int rightTalonMasterID, VictorSPX[] leftSlaves, 
                                VictorSPX[] rightSlaves, boolean leftInversion, boolean rightInversion,
                                Piston leftShifter, Piston rightShifter) {
    m_leftMaster = new NerdyTalon(leftTalonMasterID);
    m_rightMaster = new NerdyTalon(rightTalonMasterID);
    m_leftMaster.setInverted(leftInversion);
  ...
  public void shiftHigh() {
    m_leftShifter.setForwards();
    m_rightShifter.setForwards();
  }

  @Override
  public void shiftLow() {
    m_leftShifter.setReverse();
    m_rightShifter.setReverse();
  }

  @Override
  public void switchShift() {
    m_leftShifter.switchPosition();
    m_rightShifter.switchPosition();
  }

  @Override
  public boolean isHighGear() {
    if (m_leftShifter.getValue() == DoubleSolenoid.Value.kForward
        && m_rightShifter.getValue() == DoubleSolenoid.Value.kForward) {
      return true;
    }
    else {
      return false;
