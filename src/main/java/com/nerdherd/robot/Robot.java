...
public class Robot extends TimedRobot {
  ...
  public void robotInit() {
    m_drive = new Drivetrain(new NerdyTalon(RobotMap.kLeftMasterTalonID), new NerdyTalon(RobotMap.kRightMasterTalonID),  
        new CANMotorController[] { new NerdyVictorSPX(RobotMap.kLeftSlaveTalon1ID), new NerdyVictorSPX(RobotMap.kLeftSlaveTalon2ID) },
        new CANMotorController[] { new NerdyVictorSPX(RobotMap.kRightSlaveTalon1ID), new NerdyVictorSPX(RobotMap.kRightSlaveTalon2ID) }, true, false, 0.63742712872013762571);
